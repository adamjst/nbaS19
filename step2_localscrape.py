...
def step2_scrape(league, year_start, years_back, stage):
    ...
    for yr in yrs:
        if league == 'WNBA':
            print(league, year_start)
            step1_html = Path('data', 'html', '{}_{}_step1.html'.format(league, yr), header=True)
            step2_csv = Path('data', 'csv', '{}_{}_step2.csv'.format(league, yr), header=True)
...
step2_scrape('WNBA', 2019, 23, 'Regular')
step2_scrape('NBA', 2019, 71, 'Regular')
step2_scrape('ABA', 1975, 1, 'Regular')
