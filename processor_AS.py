        ...
        for yr in yrs:
            for mth in mths:
                try:
                    ...
                    #Apply Beautiful Soup to determine columns of new table ###THIS IS WHERE IT DOES NOT SEEM TO ACQUIRE THE ATTRIBUTES OF THE HTML###
                ...
                ## Find and extract relevant data point and then append under appropriate column. For Box Score, extract underlying hyperlink ##
                    ...
                    for row in content.find_all('tr'):
                        try:
                            ...
                            #print(pg.attrs)                   ###Working on extracting url, not as simple, as it requires accessing the 'href' label
                            #print(a)
